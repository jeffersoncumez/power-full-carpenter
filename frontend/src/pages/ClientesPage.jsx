...
// 🔹 Tabla de clientes con columna de pedidos (clickeable)
            ...
            <tbody>
              {clientes.map((c) => (
                ...
                >
                  ...
                  {/* 🔹 Columna Pedidos ahora enlaza a /pedidos?cliente_id=XX */}
                  <td className="border p-2">
                    <button
                      onClick={() => navigate(`/pedidos?cliente_id=${c.cliente_id}`)}
          ...
          <div className="bg-white p-6 rounded-xl shadow-2xl w-full max-w-md border border-gray-200">
            ...
            <div className="flex justify-end gap-3 mt-6">
              ...
              <button
                ...
                className="px-5 py-2 bg-blue-600 text-white rounded-lg shadow-md hover:bg-blue-700 transition font-semibold"
              >
                Guardar
              </button>
            </div>
